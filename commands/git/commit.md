...
3. If specific files are already staged, the command will only commit those files
4. Reads the current session history to understand the context of the changes
5. Performs a `git diff` to understand what changes are being committed from a code point of view
...
IMPORTANT: This command SHOULD NOT add Claude co-authorship footer to commits
